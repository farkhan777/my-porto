...
import profilePic from "../../public/images/profile/farkhan777_rounded.png"
...
export default function Home() {
  return (
    <>
      <Head>
        <title>Farkhan Hamzah Firdaus</title>
      ...
      <main className='flex items-center text-dark w-full min-h-screen dark:text-light'>
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full'>
              <Image src={profilePic} alt="Farkhan" className='w-full h-auto lg:hidden md:inline-block md:w-full' priority sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw" />
            </div>
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <p  className='my-4 text-base font-medium md:text-sm sm:text-xs'>As a skilled software engineer, I am dedicated to turning ideas into innovative web applications. 
        ...
        <div className='absolute right-8 bottom-8 inline-block w-24 md:hidden'>
          <Image src={lightBulb} alt="Farkhan" className='w-full h-auto' />
        </div>
      </main>
    </>
  )
